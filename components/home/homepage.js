...
<section class="ml-64 pt-24 bg-[#1f1f1f] fixed scrollbar-hide">
    <div class="px-12 mx-auto max-w-7xl">
        <div class="mx-auto text-center ">
            ...
            <h1 class="mb-8 text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-green-300  to-purple-600 ">
  BeatBoxx
</h1>
            ...
            <div class="mb-4 space-x-0 md:space-x-2 md:mb-8">
                <a href="/upload" class="inline-flex items-center justify-center px-6 py-3 mb-2 text-lg text-white bg-gradient-to-br from-green-400  via-blue-500 to-purple-600 rounded-2xl sm:w-auto sm:mb-0">
