...
import { message, Upload, Form, Input, DatePicker,Button, Radio, Select, TreeSelect, Cascader, InputNumber, Switch} from "antd";
    ...
    >
      <div className=" border-4 p-10 w-full rounded-xl text-center bg-slate-100 border-dashed"> 
       <p className="ant-upload-drag-icon">
        ...
        <Form.Item label="Label Name" required align="center"  tooltip="This is a required field">
